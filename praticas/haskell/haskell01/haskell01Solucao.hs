...
age :: Int -> Int -> Int
age birthyear thisyear = thisyear - birthyear
...
--Uma pista de atletismo tem a forma circular e seu diâmetro mede 80 m. Um atleta treinando nessa pista deseja correr 10 km diariamente. Determine o número mínimo de voltas completas que ele deve dar nessa pista a cada dia.


-- distance in km
laps :: Int -> Int -> Int
laps diameter distance = round $ fromIntegral distance * 1000 / (fromIntegral diameter * pi)
